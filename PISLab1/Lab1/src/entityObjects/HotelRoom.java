...
public class HotelRoom {
    ...
    public HotelRoom(int number, RoomType type, int roomsAmount, int singleBedsAmount, int doubleBedsAmount,
                     boolean hasMiniBar, boolean hasTV, boolean hasDryer, float price)
    {
        initValues(number, type, roomsAmount, singleBedsAmount, doubleBedsAmount, hasMiniBar, hasTV, hasDryer, price);
    }

    public HotelRoom(RoomType type, int roomsAmount, int singleBedsAmount, int doubleBedsAmount,
                     boolean hasMiniBar, boolean hasTV, boolean hasDryer, float price)
    {
    ...
    public void print() {
        System.out.println(Integer.toString(number) + " | " + type.toString() + " | Single beds amount : " + Integer.toString(singleBedsAmount) +
